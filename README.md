...
En la entrega de la TP, nuestro equipo profundizó en la concreción del proyecto, avanzando desde la fase de planificación hacia el diseño y desarrollo. Completamos el backend del proyecto de la aplicación móvil con el 100% de los endpoints, asegurando su plena funcionalidad. Además, finalizamos el capítulo 5, cumpliendo con todas las convenciones adecuadas para mantener la consistencia y calidad del código. También progresamos significativamente en las principales funcionalidades de autenticación y autorización del FrontEnd, mejorando su estructura y rendimiento. Paralelamente, optimizamos la organización de los wireframes y el prototipado, lo que nos permitió visualizar de forma más clara la experiencia de usuario. Para dar inicio a la construcción, ejecutamos el Sprint 1 del Frontend y el Sprint 2 del Backend, priorizando las funcionalidades más críticas. La colaboración fue clave a lo largo de todo el proceso, tal como en entregas anteriores. Mantenemos reuniones frecuentes, tanto sincrónicas como asincrónicas, para revisar el avance, aclarar dudas y tomar decisiones conjuntas. Cada miembro del equipo se enfocó en tareas específicas, garantizando siempre una comunicación abierta que favoreció la coherencia del proyecto. A través de herramientas de control de versiones y una documentación detallada, aseguramos la trazabilidad de todos los cambios y decisiones tomadas durante este sprint.
